...
const config: Config = {
    ...
    theme: {
      extend: {
        ...
        "accent-foreground-muted-hover": "hsl(var(--accent-foreground-muted-hover))",
        "accent-foreground-muted-active": "hsl(var(--accent-foreground-muted-active))",
        "accent-foreground-muted-focus": "hsl(var(--accent-foreground-muted-focus))",
        "accent-foreground-border": "hsl(var(--accent-foreground-border))",
        "accent-foreground-border-hover": "hsl(var(--accent-foreground-border-hover))",
        "accent-foreground-border-active": "hsl(var(--accent-foreground-border-active))",
        "accent-foreground-border-focus": "hsl(var(--accent-foreground-border-focus))",
        "accent-foreground-border-muted": "hsl(var(--accent-foreground-border-muted))",
        "accent-foreground-border-muted-hover": "hsl(var(--accent-foreground-border-muted-hover))",
        "accent-foreground-border-muted-active": "hsl(var(--accent-foreground-border-muted-active))",
        "accent-foreground-border-muted-focus": "hsl(var(--accent-foreground-border-muted-focus))",
